...
import requests ## request from a particular website
...
class DataLoader:
    ...
    def fetch_arxiv_papers(self, query):
        """
            ...
            Args: query
                User will search for a topic , topic will be passed as query
    ...
    def fech_google_scholar_papers(self, query):
        """
...
# dataloader = DataLoader() # Testing if the data_loader.py is working or not
# results = dataloader.fetch_arxiv_papers("machine learning") 

# # Now 'results' will contain a list of dictionaries, 
# # each representing a paper found with details like title, summary, and link.
